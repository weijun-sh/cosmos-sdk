...
//aliases functionality in the github.com/weijun-sh/cosmos-sdk/errors module
//that used to be in this package, and provides some helpers for converting
//errors to ABCI response code.
//
//New code should generally import github.com/weijun-sh/cosmos-sdk/errors directly
//and define a custom set of errors in custom codespace, rather than importing
//this package.
package errors

import (
	errorsmod "github.com/weijun-sh/cosmos-sdk/errors"
)
