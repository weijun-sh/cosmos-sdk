...
import (
	...
	authtest "github.com/weijun-sh/cosmos-sdk/x/auth/client/testutil"
	...
	for _, tc := range testCases {
		s.Run(tc.name, func() {
			...
			if tc.expErr {
				...
				// ref: https://github.com/weijun-sh/cosmos-sdk/issues/8680
				// ref: https://github.com/weijun-sh/cosmos-sdk/issues/8681
