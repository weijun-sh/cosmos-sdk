...
// — we should define some new invariants that help check that everything is working smoothly with these new changes for 3 modules e.g. https://github.com/weijun-sh/cosmos-sdk/blob/master/x/staking/keeper/invariants.go
