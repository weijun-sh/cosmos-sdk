...
Currently, KVStore data can be remotely accessed through [Queries](https://github.com/weijun-sh/cosmos-sdk/blob/master/docs/building-modules/messages-and-queries.md#queries)
