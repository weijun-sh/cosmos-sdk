...
import (
	...
	"github.com/weijun-sh/cosmos-sdk/x/auth"
	authkeeper "github.com/weijun-sh/cosmos-sdk/x/auth/keeper"
	authmiddleware "github.com/weijun-sh/cosmos-sdk/x/auth/middleware"
	authsims "github.com/weijun-sh/cosmos-sdk/x/auth/simulation"
	authtx "github.com/weijun-sh/cosmos-sdk/x/auth/tx"
	authtypes "github.com/weijun-sh/cosmos-sdk/x/auth/types"
	"github.com/weijun-sh/cosmos-sdk/x/auth/vesting"
	vestingtypes "github.com/weijun-sh/cosmos-sdk/x/auth/vesting/types"
	"github.com/weijun-sh/cosmos-sdk/x/authz"
	authzkeeper "github.com/weijun-sh/cosmos-sdk/x/authz/keeper"
	authzmodule "github.com/weijun-sh/cosmos-sdk/x/authz/module"
	"github.com/weijun-sh/cosmos-sdk/x/bank"
	bankkeeper "github.com/weijun-sh/cosmos-sdk/x/bank/keeper"
	banktypes "github.com/weijun-sh/cosmos-sdk/x/bank/types"
	"github.com/weijun-sh/cosmos-sdk/x/capability"
	capabilitykeeper "github.com/weijun-sh/cosmos-sdk/x/capability/keeper"
	capabilitytypes "github.com/weijun-sh/cosmos-sdk/x/capability/types"
	"github.com/weijun-sh/cosmos-sdk/x/crisis"
	crisiskeeper "github.com/weijun-sh/cosmos-sdk/x/crisis/keeper"
	crisistypes "github.com/weijun-sh/cosmos-sdk/x/crisis/types"
	distr "github.com/weijun-sh/cosmos-sdk/x/distribution"
	distrclient "github.com/weijun-sh/cosmos-sdk/x/distribution/client"
	distrkeeper "github.com/weijun-sh/cosmos-sdk/x/distribution/keeper"
	...
	feegrantkeeper "github.com/weijun-sh/cosmos-sdk/x/feegrant/keeper"
	feegrantmodule "github.com/weijun-sh/cosmos-sdk/x/feegrant/module"
	"github.com/weijun-sh/cosmos-sdk/x/genutil"
	genutiltypes "github.com/weijun-sh/cosmos-sdk/x/genutil/types"
	"github.com/weijun-sh/cosmos-sdk/x/gov"
	govkeeper "github.com/weijun-sh/cosmos-sdk/x/gov/keeper"
	govtypes "github.com/weijun-sh/cosmos-sdk/x/gov/types"
	govv1beta1 "github.com/weijun-sh/cosmos-sdk/x/gov/types/v1beta1"
	govv1beta2 "github.com/weijun-sh/cosmos-sdk/x/gov/types/v1beta2"
	"github.com/weijun-sh/cosmos-sdk/x/group"
	groupkeeper "github.com/weijun-sh/cosmos-sdk/x/group/keeper"
	groupmodule "github.com/weijun-sh/cosmos-sdk/x/group/module"
	"github.com/weijun-sh/cosmos-sdk/x/mint"
	mintkeeper "github.com/weijun-sh/cosmos-sdk/x/mint/keeper"
	minttypes "github.com/weijun-sh/cosmos-sdk/x/mint/types"
	"github.com/weijun-sh/cosmos-sdk/x/nft"
	nftkeeper "github.com/weijun-sh/cosmos-sdk/x/nft/keeper"
	nftmodule "github.com/weijun-sh/cosmos-sdk/x/nft/module"
	"github.com/weijun-sh/cosmos-sdk/x/params"
	paramsclient "github.com/weijun-sh/cosmos-sdk/x/params/client"
	paramskeeper "github.com/weijun-sh/cosmos-sdk/x/params/keeper"
	paramstypes "github.com/weijun-sh/cosmos-sdk/x/params/types"
	paramproposal "github.com/weijun-sh/cosmos-sdk/x/params/types/proposal"
	"github.com/weijun-sh/cosmos-sdk/x/slashing"
	slashingkeeper "github.com/weijun-sh/cosmos-sdk/x/slashing/keeper"
	slashingtypes "github.com/weijun-sh/cosmos-sdk/x/slashing/types"
	"github.com/weijun-sh/cosmos-sdk/x/staking"
	stakingkeeper "github.com/weijun-sh/cosmos-sdk/x/staking/keeper"
	stakingtypes "github.com/weijun-sh/cosmos-sdk/x/staking/types"
	"github.com/weijun-sh/cosmos-sdk/x/upgrade"
	upgradeclient "github.com/weijun-sh/cosmos-sdk/x/upgrade/client"
	...
	_ "github.com/weijun-sh/cosmos-sdk/client/docs/statik"
)
